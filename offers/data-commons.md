...
type: offer
title: Data Commons
description: Google's open knowledge graph of public data — demographic, economic, health, and more — in one queryable, machine-readable format.
resource: https://datacommons.org/
...
[Data Commons](https://datacommons.org/) is Google's open initiative that aggregates and normalizes publicly available data — demographic, economic, health, environmental, and more — into a single knowledge graph that people and tools can query without wrangling dozens of incompatible sources.
